...
# Directory of the JAVA compressed tar file

JAVA_TAR_GZ_FILE_DIR=$JAVA_DIR

# Name of the JAVA tar archive

JAVA_TAR_GZ_FILE_NAME=OpenJDK11U-jdk_x64_linux_hotspot_11.0.24_8.tar.gz

# Name of the extracted JDK directory in the OS (By using tar command. This will be used to define the JDK_HOME directory)

JAVA_EXTRACTED_DIRECTORY_NAME=jdk-11.0.24+8

# Location of Dockerfile

DOCKERFILE_PATH=../DockerfileDir/redhat.ubi8.gmsec.java.Dockerfile
...
sudo docker buildx build \
        ...
        --build-arg JAVA_EXTRACTED_DIRECTORY_NAME=${JAVA_EXTRACTED_DIRECTORY_NAME} \
        -f ${DOCKERFILE_PATH} \
